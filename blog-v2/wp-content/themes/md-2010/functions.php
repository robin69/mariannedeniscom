...
function twentyten_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-author vcard">
			<img src="<?php bloginfo('url'); ?>/wp-content/themes/twentyten/images/md-avatar.jpg" width="30" height="30" alt="" />
		...
		<div class="comment-meta commentmetadata">
			<?php printf( __( '%s', 'twentyten' ), sprintf( '<span class="fn">%s</span>', get_comment_author_link() ) ); ?><br />
			<span class="comment-date-txt"><?php comment_date(); ?> &agrave; <?php comment_time(); ?></span>
