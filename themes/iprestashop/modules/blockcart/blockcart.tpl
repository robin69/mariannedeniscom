...
<ul class="pageitem">
	<li class="menu">
		<a href="{$base_dir}cart.php">
			<img alt="{l s='cart' mod='blockcart'}" src="{$img_dir}cart.png" />
			<span class="name">
				{l s='Cart' mod='blockcart'}
				{if $cart_qties > 0}
					[{$cart_qties} {if $cart_qties > 1}{l s='products' mod='blockcart'}{else}{l s='product' mod='blockcart'}{/if}
					- {if $priceDisplay == 1}{convertPrice price=$cart->getOrderTotal(false)}{else}{convertPrice price=$cart->getOrderTotal(true)}{/if}]
				{else}
...
<script type="text/javascript" src="{$module_template_dir}ajax-cart.js"></script>
{/if}
