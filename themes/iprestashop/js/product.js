...
function displayImage(domAAroundImgThumb)
{
	...
	{
		var src = domAAroundImgThumb.attr('href');
		var newSrc = src.replace(ips_img_big,ips_img_large);
...
$(document).ready(function()
{
	...
	$('#customizedDatas input').click(function() {
		...
		$('#customizedDatas').append('<img src="' + img_ps_dir + 'loader.gif" alt="" /> ' + uploading_in_progress);
	});
