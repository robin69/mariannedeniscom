...
{/if}
	...
	<!-- ANALYTICS -->
	<!-- Google Tag Manager -->
		<script type="text/javascript" src="{$js_dir}robin_tracking.js"></script>
...
<script>{literal}(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
...
<div id="autopromo-header-center">
				...
				<!--<img src="{$img_dir}newsletter-block-25-v3.jpg" height="230" title="Bijoux fantaisie en promotion - Pour 50€ d'achat : -25% + frais de port offerts. De plus, si vous passez commande avant le 8/12 la livraison de vos bijoux avant Noël est garantie ! C'est l'occation ou jamais de bénéficier de bijoux pas cher !"/>
			--></div> 
			...
			<div id="header-top-right">
				...
				<div id="account">
					...
					<span>|</span>
					<a href="{$content_dir}order.php" title="" onfocus="this.blur();"><img src="{$img_dir}icon/icon-commandes.jpg" class="basket_icon"/>Panier (<span class="ajax_cart_quantity">{$cart_qties}</span>)</a>
				</div>
			</div>
