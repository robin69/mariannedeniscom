...
<h2 class="page_title_h2">{if !isset($email_create)}{l s='Log in'}{else}{l s='Create your account'}{/if}</h2>
...
{if !isset($email_create)}
	<form action="{$base_dir_ssl}authentication.php" method="post" id="create-account_form" class="std">
		<fieldset>
			...
			<p>{l s='Enter your e-mail address to create your account'}.</p>
			<p>
			...
			{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
				<input type="submit" name="SubmitCreate" class="button_large" id="SubmitCreate" value="{l s='Create your account'}" />
	...
	<form action="{$base_dir_ssl}authentication.php" method="post" id="login_form" class="std">
		<fieldset>
			...
			<br class="clear" />
				<br />
				{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
				<input type="submit" name="SubmitLogin" class="button" id="SubmitLogin" value="{l s='Log in'}" />
...
<form action="{$base_dir_ssl}authentication.php" method="post" id="account-creation_form" class="std">
	...
	<span class="account-creation_form_required"><sup>*</sup>{l s='Required field'}</span>
	<br class="clear" />
	...
	<fieldset class="account_creation">
		...
		<p class="textarea">
			...
			<textarea name="other" id="other" >{if isset($smarty.post.other)}{$smarty.post.other}{/if}</textarea>
		</p>
		<p class="text">
