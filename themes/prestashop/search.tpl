...
<h2 class="page_title_h2">Votre recherche&nbsp;{if $nbProducts > 0}"{if $search_query}{$search_query|escape:'htmlall':'UTF-8'}{elseif $tag}{$tag|escape:'htmlall':'UTF-8'}{elseif $ref}{$ref|escape:'htmlall':'UTF-8'}{/if}"{/if}</h2>
