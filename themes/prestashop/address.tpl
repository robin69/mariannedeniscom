...
<h2 class="page_title_h2">{l s='Your addresses'}</h2>
...
<div class="my-account-container">
	...
	<h3 style="display:none;">{if isset($id_address)}{l s='Modify the address'} {if isset($smarty.post.alias)}"{$smarty.post.alias}"{elseif $address->alias}"{$address->alias|escape:'htmlall':'UTF-8'}"{/if}{else}{l s='To add a new address, please fill out the form below.'}{/if}</h3>
