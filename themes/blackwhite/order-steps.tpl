...
<div id="commitment">  
  <ul>
   ...
   <p>{l s='09 rue de Trevise 75009 Paris'}</p>
   <h6>{l s='Respect and privacy of your personal data'}</h6>
   <p>{l s=' we do not sell or rent your personnal information to anyone'}</p>
   <h6>{l s='Contact'}</h6>
   <p>{l s='@'} :  <a href="mailto:contact@blackwhite.fr">contact@blackwhite.fr</a><br />
    {l s='Phone'} : <span><a href="#">{l s='+331 10 10 10'}</a></span><br />
   </p><br />
   <p><a href="{$link->getCMSLink(5, $securepayment)}"><img src="{$base_dir}themes/blackwhite/img/payment_logo.gif" /></a></p>
  </ul>
</div>
