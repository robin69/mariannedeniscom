...
{/if}
	...
	<link href="{$content_dir}modules/categoriesbar/chromestyle.css" rel="stylesheet" type="text/css" media="{$media}" />
{if isset($css_files)}
...
{/if}
		...
		<script type="text/javascript" src="{$content_dir}js/jquery/jquery.slider.js"></script>
{if isset($js_files)}
