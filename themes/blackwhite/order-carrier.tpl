  ...
  {if $giftAllowed}
   <div id="gift_div">
	<p>
	 ...
	 <label for="gift_cb">{l s='I want to receive my order in Gift packaging'}{if $gift_wrapping_price > 0}({$gift_wrapping_price}&nbsp;euros){/if}</label>
	</p>
	<p id="wrapping-more" style="display:none;">{l s='If you wish, you can add a note to the gift:'} 
...
{/if}
	...
	<p>
		...
		<label for="recyclable" style="color:black; font-size:11px; text-transform:uppercase; font-weight:bold">{l s='I agree to receive my order in recycled packaging'}.</label>
	</p>
	{/if}
<div class="condition">	
	<p class="checkbox">
