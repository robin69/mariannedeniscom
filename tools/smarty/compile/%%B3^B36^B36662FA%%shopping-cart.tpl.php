<?php /* Smarty version 2.6.20, created on 2013-03-05 08:54:56
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/shopping-cart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/shopping-cart.tpl', 7, false),array('function', 'displayPrice', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/shopping-cart.tpl', 64, false),array('modifier', 'escape', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/shopping-cart.tpl', 29, false),array('modifier', 'intval', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/shopping-cart.tpl', 205, false),array('modifier', 'secureReferrer', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/shopping-cart.tpl', 301, false),)), $this); ?>
...
<h2 class="page_title_h2"><?php echo smartyTranslate(array('s' => 'Shopping cart summary'), $this);?>
</h2>
...
<?php endif; ?></p> -->
	<p class='cart-top-warning align_center'>Frais de port offerts à partir de <strong>45&euro;</strong> d'achat ! </p>
	<div id="order-detail-content" class="table_block">
		<table id="cart_summary" class="std">
		
			<thead>
				<tr>
					<th class="cart_product first_item" style="padding-left:10px;"><?php echo smartyTranslate(array('s' => 'Product'), $this);?>
</th>
					...
					<th class="cart_total last_item" style="text-align:right;padding-right:20px;"><?php echo smartyTranslate(array('s' => 'Total'), $this);?>
</th>
				</tr>
			</thead>
			...
			<tfoot>
				...
				<tr class="cart_total_price">
					...
					<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_price_without_tax']), $this);?>
</td>
				</tr>
				<tr class="cart_total_voucher">
					<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total tax:'), $this);?>
</td>
					<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_tax']), $this);?>
</td>
				</tr>
					...
					<?php if ($this->_tpl_vars['priceDisplay']): ?>
						<tr class="cart_total_price">
							...
							<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_products']), $this);?>
</td>
						</tr>
					<?php else: ?>
						<tr class="cart_total_price">
							...
							<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_products_wt']), $this);?>
</td>
						</tr>
					<?php endif; ?>
					...
					<?php if ($this->_tpl_vars['shippingCost'] > 0): ?>
						<?php if ($this->_tpl_vars['priceDisplay']): ?>
							<tr class="cart_total_delivery">
								...
								<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['shippingCostTaxExc']), $this);?>
</td>
							</tr>
						<?php else: ?>
							<tr class="cart_total_delivery">
								...
								<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['shippingCost']), $this);?>
</td>
							</tr>
						<?php endif; ?>
					<?php endif; ?>
				...
				<tr class="cart_total_price">
					...
					<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_price']), $this);?>
</td>
				</tr>
				<?php else: ?>
				<tr class="cart_total_price">
					<td colspan="5" class="big-cart-text">TOTAL</td>
					<td class="big-cart-text" style="padding-right:10px;" ><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_price_without_tax']), $this);?>
</td>
				</tr>
				
					<tr class="cart_total_price">
						<td colspan="5" class="small-cart-text">dont total produits</td>
						<td class="price small-cart-text" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_products']), $this);?>
</td>
					</tr>
					
					<?php if ($this->_tpl_vars['shippingCost'] > 0): ?>
						<tr class="cart_total_delivery">
							<td colspan="5" class="small-cart-text">dont total frais de port</td>
							<td class="price small-cart-text" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['shippingCostTaxExc']), $this);?>
</td>
						</tr>
					<?php endif; ?>
					...
					<?php if ($this->_tpl_vars['use_taxes']): ?>
						<?php if ($this->_tpl_vars['priceDisplay']): ?>
							<tr class="cart_total_voucher">
								...
								<td class="price-discount" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_discounts_tax_exc']), $this);?>
</td>
							</tr>
						<?php else: ?>
							<tr class="cart_total_voucher">
								...
								<td class="price-discount" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_discounts']), $this);?>
</td>
							</tr>
						<?php endif; ?>
					<?php else: ?>
					...
					<?php if ($this->_tpl_vars['use_taxes']): ?>
						<?php if ($this->_tpl_vars['priceDisplay']): ?>
							<tr class="cart_total_voucher">
								...
								<td class="price-discount" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_wrapping_tax_exc']), $this);?>
</td>
							</tr>
						<?php else: ?>
							<tr class="cart_total_voucher">
								...
								<td class="price-discount" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_wrapping']), $this);?>
</td>
							</tr>
						<?php endif; ?>
					<?php else: ?>
...
<tr class="cart_free_shipping">
					...
					<td class="price" style="padding-right:10px;"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['free_ship']), $this);?>
</td>
				</tr>
-->
				<?php endif; ?>
...
<?php endif; ?><?php echo smartyTranslate(array('s' => ':'), $this);?>
 : <strong><?php echo $this->_tpl_vars['textField']['value']; ?>
</strong></li><?php endforeach; endif; unset($_from); ?>
										</ul>
									<?php endif; ?>
								<?php endforeach; endif; unset($_from); ?>
							</td>
...
" class="icon" /></a>
								<p class="cart_quantity_nb"><?php echo $this->_tpl_vars['customization']['quantity']; ?>
</p>
...
order.php" method="post" id="voucher">
			<fieldset>
				...
				<p>
					<label for="discount_name">Veuillez saisir votre (ou vos) code(s) de r&eacute;duction : </label>
...
<?php endif; ?>" />&nbsp;<input type="submit" name="submitAddDiscount" value="" class="button button_add_voucher submit" /><input type="hidden" name="submitDiscount" />
				</p>
				<!-- <p class="submit"></p> -->
			</fieldset>
		</form>
	...
	<div class="order_delivery" style="display:none;">
...
<?php endif; ?>" class="button_large" title="">&laquo; <?php echo smartyTranslate(array('s' => 'Continue shopping'), $this);?>
</a>
	</p>
