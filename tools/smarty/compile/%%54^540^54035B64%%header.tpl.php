<?php /* Smarty version 2.6.20, created on 2014-07-09 22:00:42
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/header.tpl', 4, false),array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/header.tpl', 71, false),)), $this); ?>
...
robin_tracking.js"></script>
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-6KCB" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script><?php echo '(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({\'gtm.start\':new Date().getTime(),event:\'gtm.js\'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!=\'dataLayer\'?\'&l=\'+l:\'\';j.async=true;j.src=\'//www.googletagmanager.com/gtm.js?id=\'+i+dl;f.parentNode.insertBefore(j,f);})(window,document,\'script\',\'dataLayer\',\'GTM-6KCB\');
'; ?>
</script>
...
smarty_core_smarty_include_php(array('smarty_file' => "http://www.mariannedenis.com/prestashop/analyticstracking.php", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
 -->
	...
	<?php if (! $this->_tpl_vars['content_only']): ?>
		...
		<div id="main">
			<!-- <h1 class="solde">SOLDES<span class="minus">jusqu'à</span><br />-70%</h1> -->
		<!-- LEFT COLUMN -->
		<div id="leftcol">
			<!-- LOGO -->
			<div id="logo">
...
<div id="autopromo-header-center">
				<!-- /theme/prestashop/img/ -->
				<!--<img src="<?php echo $this->_tpl_vars['img_dir']; ?>
newsletter-block-25-v3.jpg" height="230" title="Bijoux fantaisie en promotion - Pour 50€ d'achat : -25% + frais de port offerts. De plus, si vous passez commande avant le 8/12 la livraison de vos bijoux avant Noël est garantie ! C'est l'occation ou jamais de bénéficier de bijoux pas cher !"/>
			--></div> 
			
			<div class="code_promo">Code promo : <span class="promo">CADEAUX</span></div>
			<!-- QUOTE -->
			<!-- <div id="subnav-quote">
...
my-account.php" title="" onfocus="this.blur();">Mon compte</a>
					<span>|</span>
					<a href="<?php echo $this->_tpl_vars['content_dir']; ?>
order.php" title="" onfocus="this.blur();"><img src="<?php echo $this->_tpl_vars['img_dir']; ?>
icon/icon-commandes.jpg" class="basket_icon"/>Panier (<span class="ajax_cart_quantity"><?php echo $this->_tpl_vars['cart_qties']; ?>
</span>)</a>
				</div>
			</div>
