...
<?php endif; ?></p> -->
	<p class='cart-top-warning align_center'>Frais de port offerts à partir de <strong>50&euro;</strong> d'achat ! </p>
...
order.php" method="post" id="voucher">
			<fieldset>
				...
				<p>
					<label for="discount_name">Veuillez saisir votre code promo puis cliquez sur le <strong>+</strong> : </label>
