<?php /* Smarty version 2.6.20, created on 2013-09-04 00:12:22
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/themes/iprestashop/modules/bankwire/payment_execution.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/iprestashop/modules/bankwire/payment_execution.tpl', 3, false),array('function', 'convertPriceWithCurrency', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/iprestashop/modules/bankwire/payment_execution.tpl', 35, false),array('modifier', 'count', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/iprestashop/modules/bankwire/payment_execution.tpl', 33, false),)), $this); ?>
<div id="topbar">
	<div id="leftnav">
		<a href="<?php echo $this->_tpl_vars['base_dir']; ?>
"><img alt="<?php echo smartyTranslate(array('s' => 'home','mod' => 'bankwire'), $this);?>
" src="<?php echo $this->_tpl_vars['ips_img_dir']; ?>
home.png" /></a>
		<a href="<?php echo $this->_tpl_vars['base_dir']; ?>
?browse=1"><?php echo smartyTranslate(array('s' => 'Browse','mod' => 'bankwire'), $this);?>
</a>
	</div>
	<div id="rightbutton">
		<a href="<?php echo $this->_tpl_vars['base_dir_ssl']; ?>
my-account.php"><?php echo smartyTranslate(array('s' => 'My account','mod' => 'bankwire'), $this);?>
</a>
	</div>
</div>
...
<?php if ($this->_tpl_vars['nbProducts'] <= 0): ?>
	<?php ob_start(); ?><?php echo smartyTranslate(array('s' => 'Your shopping cart is empty.','mod' => 'bankwire'), $this);?>
...
<?php else: ?>
	...
	<span class="graytitle"><?php echo smartyTranslate(array('s' => 'Bank wire payment','mod' => 'bankwire'), $this);?>
</span>
...
" class="price"><?php echo Product::convertPriceWithCurrency(array('price' => $this->_tpl_vars['total'],'currency' => $this->_tpl_vars['currencies']['0']), $this);?>
	...
	<?php if (count($this->_tpl_vars['currencies']) > 1): ?>
				<li class="textbox">
					...
					<br /><?php echo smartyTranslate(array('s' => 'Choose one of the following:','mod' => 'bankwire'), $this);?>
...
">
	...
	<?php endif; ?>
			...
			<ul class="pageitem">
				<li class="menu">
					<a href="javascript:$('#paymentForm').submit()" title="<?php echo smartyTranslate(array('s' => 'Next','mod' => 'bankwire'), $this);?>
">
						<img alt="<?php echo smartyTranslate(array('s' => 'next','mod' => 'bankwire'), $this);?>
" src="<?php echo $this->_tpl_vars['img_dir']; ?>
cart_ok.png" />
						<span class="name"><?php echo smartyTranslate(array('s' => 'I confirm my order','mod' => 'bankwire'), $this);?>
</span>
						<span class="arrow"></span>
					</a>
				</li>
				<li class="menu">
					<a href="<?php echo $this->_tpl_vars['base_dir_ssl']; ?>
order.php?step=3" title="<?php echo smartyTranslate(array('s' => 'previous','mod' => 'bankwire'), $this);?>
">
						<img alt="<?php echo smartyTranslate(array('s' => 'previous','mod' => 'bankwire'), $this);?>
" src="<?php echo $this->_tpl_vars['img_dir']; ?>
back.png" />
						<span class="name"><?php echo smartyTranslate(array('s' => 'Other payment methods','mod' => 'bankwire'), $this);?>
</span>
					</a>
				</li>
			</ul>
