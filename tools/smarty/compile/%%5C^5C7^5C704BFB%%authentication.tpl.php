<?php /* Smarty version 2.6.20, created on 2014-07-09 13:01:36
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/authentication.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/authentication.tpl', 1, false),array('modifier', 'intval', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/authentication.tpl', 6, false),array('modifier', 'escape', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/authentication.tpl', 14, false),array('modifier', 'stripslashes', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/authentication.tpl', 38, false),)), $this); ?>
...
<h2 class="page_title_h2"><?php if (! isset ( $this->_tpl_vars['email_create'] )): ?><?php echo smartyTranslate(array('s' => 'Log in'), $this);?>
...
authentication.php" method="post" id="create-account_form" class="std">
		<fieldset>
			...
			<p><?php echo smartyTranslate(array('s' => 'Enter your e-mail address to create your account'), $this);?>
.</p>
			<p>
...
" /><?php endif; ?>
				<input type="submit" name="SubmitCreate" class="button_large" id="SubmitCreate" value="<?php echo smartyTranslate(array('s' => 'Create your account'), $this);?>
" />
...
<?php endif; ?>" class="account_input" /></span>
			...
			<br class="clear" />
				...
				<?php if (isset ( $this->_tpl_vars['back'] )): ?><input type="hidden" class="hidden" name="back" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['back'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" /><?php endif; ?>
				<input type="submit" name="SubmitLogin" class="button" id="SubmitLogin" value="<?php echo smartyTranslate(array('s' => 'Log in'), $this);?>
" />
...
<?php endif; ?>" />
			<sup>*</sup>
			<span class="form_info">(ex: Domicile, Bureau...)</span>
		</p>
...
" <?php if (( $this->_tpl_vars['sl_country'] == $this->_tpl_vars['v']['id_country'] )): ?> selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['v']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
		...
		<p class="textarea">
			...
			<textarea name="other" id="other" ><?php if (isset ( $_POST['other'] )): ?><?php echo $_POST['other']; ?>
<?php endif; ?></textarea>
		</p>
		<p class="text">
