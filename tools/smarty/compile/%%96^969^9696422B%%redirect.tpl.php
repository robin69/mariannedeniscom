<?php /* Smarty version 2.6.20, created on 2014-05-09 22:01:24
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/modules/paypal/redirect.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/var/www/vhosts/mariannedenis.com/httpdocs/modules/paypal/redirect.tpl', 10, false),)), $this); ?>
<html>
	<head>
...
" method="post" id="paypal_form" class="hidden">
			...
			<input type="hidden" name="first_name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['address']->firstname)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" />
			<input type="hidden" name="last_name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['address']->lastname)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" />
			<input type="hidden" name="address1" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['address']->address1)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" />
			<?php if ($this->_tpl_vars['address']->address2 != NULL): ?>
			<input type="hidden" name="address2" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['address']->address2)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" />
			<?php endif; ?>
			<input type="hidden" name="city" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['address']->city)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" />
...
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
<?php if (isset ( $this->_tpl_vars['product']['attributes'] )): ?> - <?php echo ((is_array($_tmp=$this->_tpl_vars['product']['attributes'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
<?php endif; ?>" />
...
" />
			<input type="hidden" name="return" value="<?php echo $this->_tpl_vars['url']; ?>
...
&slowvalidation" />
			<input type="hidden" name="cancel_return" value="<?php echo $this->_tpl_vars['url']; ?>
index.php" />
			<input type="hidden" name="notify_url" value="<?php echo $this->_tpl_vars['url']; ?>
