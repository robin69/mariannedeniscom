<?php /* Smarty version 2.6.20, created on 2013-02-23 18:53:24
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/themes/iprestashop/prices-drop.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/iprestashop/prices-drop.tpl', 3, false),)), $this); ?>
<div id="topbar">
	<div id="leftnav">
...
<div id="content">
	<span class="graytitle"><?php echo smartyTranslate(array('s' => 'Price drop'), $this);?>
</span>
...
unset($_smarty_tpl_vars);
 ?>
<?php else: ?>
	<?php ob_start(); ?><?php echo smartyTranslate(array('s' => 'No price drop.'), $this);?>
