<?php /* Smarty version 2.6.20, created on 2014-06-30 17:53:17
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/order-address.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'intval', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/order-address.tpl', 6, false),array('modifier', 'addslashes', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/order-address.tpl', 6, false),array('modifier', 'default', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/order-address.tpl', 6, false),array('modifier', 'escape', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/order-address.tpl', 30, false),array('modifier', 'count', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/order-address.tpl', 35, false),array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/themes/prestashop/order-address.tpl', 12, false),)), $this); ?>
...
<h2 class="page_title_h2"><?php echo smartyTranslate(array('s' => 'Addresses'), $this);?>
</h2>
...
" <?php if ($this->_tpl_vars['addresses'][$this->_sections['address']['index']]['id_address'] == $this->_tpl_vars['cart']->id_address_invoice && $this->_tpl_vars['cart']->id_address_delivery != $this->_tpl_vars['cart']->id_address_invoice): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['addresses'][$this->_sections['address']['index']]['alias'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
				...
				<?php else: ?>
					<br /><a href="<?php echo $this->_tpl_vars['base_dir_ssl']; ?>
...
" class="button_large"><?php echo smartyTranslate(array('s' => 'Add a new address'), $this);?>
			...
			<ul class="address item" id="address_delivery">
				<li class="address_title">
					<?php echo smartyTranslate(array('s' => 'Your delivery address'), $this);?>

					<div class="address_update address_update_cart"><a href="<?php echo $this->_tpl_vars['base_dir_ssl']; ?>
...
"></a></div>
				...
				<li class="address_update"><a style="display:none;" href="<?php echo $this->_tpl_vars['base_dir_ssl']; ?>
address.php?id_address=<?php echo ((is_array($_tmp=$this->_tpl_vars['address']['id_address'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
&amp;back=order.php&amp;step=1<?php if ($this->_tpl_vars['back']): ?>&mod=<?php echo $this->_tpl_vars['back']; ?>
<?php endif; ?>" title="<?php echo smartyTranslate(array('s' => 'Update'), $this);?>
"><?php echo smartyTranslate(array('s' => 'Update'), $this);?>
			...
			<ul class="address alternate_item" id="address_invoice" style="margin-left:30px;">
				<li class="address_title">
					<?php echo smartyTranslate(array('s' => 'Your billing address'), $this);?>
...
" class="button_large"><?php echo smartyTranslate(array('s' => 'Add a new address'), $this);?>
			...
			<div id="ordermsg">
				...
				<p class="textarea"><textarea name="message"><?php echo $this->_tpl_vars['oldMessage']; ?>
</textarea></p>
			</div>
		</div>
