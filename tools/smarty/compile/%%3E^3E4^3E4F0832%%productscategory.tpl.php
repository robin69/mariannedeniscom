<?php /* Smarty version 2.6.20, created on 2010-11-28 13:21:06
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/productscategory/productscategory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/productscategory/productscategory.tpl', 5, false),array('modifier', 'htmlspecialchars', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/productscategory/productscategory.tpl', 17, false),array('modifier', 'truncate', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/productscategory/productscategory.tpl', 18, false),array('modifier', 'escape', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/productscategory/productscategory.tpl', 18, false),)), $this); ?>
...
" />
					<p><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['categoryProduct']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 25, '...') : smarty_modifier_truncate($_tmp, 25, '...')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</p>
