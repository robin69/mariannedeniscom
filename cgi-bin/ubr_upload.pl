...
#**********************************************************************************************************************************
my $TEMP_DIR        = '/home/mdcrea/public_html/v4/temp/ ';                    # * ATTENTION * : The $TEMP_DIR value MUST be duplicated in the "ubr_ini.php" file
...
my $UBER_VERSION = "6.7.4";                                # Version of UU
my $THIS_VERSION = "3.2";                                  # Version of this script
...
my $num_config_settings = keys(%config);
############################################################################################################################################################
