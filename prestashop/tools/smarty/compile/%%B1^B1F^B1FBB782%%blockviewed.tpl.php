<?php /* Smarty version 2.6.20, created on 2010-12-16 01:11:48
         compiled from /var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/blockviewed/blockviewed.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/blockviewed/blockviewed.tpl', 3, false),array('function', 'm', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/blockviewed/blockviewed.tpl', 11, false),array('modifier', 'escape', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/blockviewed/blockviewed.tpl', 9, false),array('modifier', 'truncate', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/blockviewed/blockviewed.tpl', 10, false),array('modifier', 'strip_tags', '/var/www/vhosts/mariannedenis.com/httpdocs/prestashop/modules/blockviewed/blockviewed.tpl', 11, false),)), $this); ?>
...
?>
				...
				<li class="clearfix<?php if (($this->_foreach['myLoop']['iteration'] == $this->_foreach['myLoop']['total'])): ?> last_item<?php elseif (($this->_foreach['myLoop']['iteration'] <= 1)): ?> first_item<?php else: ?> item<?php endif; ?>">
					<a href="<?php echo $this->_tpl_vars['link']->getProductLink($this->_tpl_vars['viewedProduct']->id,$this->_tpl_vars['viewedProduct']->link_rewrite,$this->_tpl_vars['viewedProduct']->category_rewrite,$this->_tpl_vars['viewedProduct']->ean13); ?>
...
" /></a>
					<h5><a href="<?php echo $this->_tpl_vars['link']->getProductLink($this->_tpl_vars['viewedProduct']->id,$this->_tpl_vars['viewedProduct']->link_rewrite,$this->_tpl_vars['viewedProduct']->category_rewrite,$this->_tpl_vars['viewedProduct']->ean13); ?>
" title="<?php echo smartyTranslate(array('s' => 'More about','mod' => 'blockviewed'), $this);?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['viewedProduct']->name)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
